      ...
      <?php if (isset($book) && count($book) > 0) : ?>
        ...
        <div class="col-sm-12 col-md-4">
          <div class="reservation-vertical clearfix">
            ...
            <p>Date du debut: <span style="font-weight:600;"><?= $book['checkin'] ?></span></p>
            <p>Date de fin: <span style="font-weight:600;"><?= $book['checkout'] ?></span></p>
            ...
            <div class="text-muted">
              ...
              <p>
                NB : Conservez votre code de réservation (Copiez-le ou faites une capture d'écran). <br> Ne le Partagez pas avec des inconnues.
              </p>
            </div>
...
<section class="parallax-effect mt100">
  <div id="parallax-image" style="background-image: url(./images/rooms/site/e1.jpeg);">
