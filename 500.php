...
<head>
  <meta charset="utf-8">
  <title>
    <?= isset($_SESSION['sys']['site_name']) ? $_SESSION['sys']['site_name'] : '500' ?>
  </title>
...
<body>
    ...
    <div class="navbar yamm navbar-default" id="sticky">
      <div class="container">
        <div class="navbar-header" style="height: 100%;">
          ...
          <a href="index.php" class="navbar-brand nav-persoo">
            <!-- Logo -->
            <div id="logo">
  ...
  <section class="parallax-effect">
    <div id="parallax-pagetitle" style="background-image: url(./images/site/E7.jpeg);">
  ...
  <section class="error-404 mb-5" style="margin-bottom: 100px;">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h2 class="fadeIn appear">500</h2>
          <h3 class="fadeIn appear" data-start="700">
            Eh bien, c'est embarrassant... Une erreur côte serveur est survenue.
          </h3>
          <a style="border: 2px solid #5c5c5c; color: #5c5c5c;" href="<?= isset($path) ? $path : '/' ?>index.php" class="btn btn-lg btn-default mt30 fadeIn appear" data-start="1000" href="<?= isset($path) ? $path : '/' ?>index.php">
